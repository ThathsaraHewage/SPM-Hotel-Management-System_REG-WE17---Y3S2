...
const ManageRooms = () => {
  ...
  return (
    <Base navigation="Home > Accomodations > A/C Rooms" title="Accomodations" description="Our Air Conditioned Room Categories">
                ...
                <div className="card text-center">
                  ...
                  <div className="card-body bg-white text-dark rounded m-3">
                    ...
                    <p className="card-text m-0">
                      <b>Facilities:</b> <br/>{RoomTypes.description}
                    </p>
                    <p className="card-text m-0">
