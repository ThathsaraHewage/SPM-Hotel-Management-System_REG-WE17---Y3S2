...
const BookingVenue = ({ match }) => {
  ...
  const {
  firstname,lastname,emailAddress,phoneNumber,preferredDate,additionalComment,holdersname,cardnumber,cvv,expdate,
    loading,
    error,
    createdProduct,
    getaRedirect,
  ...
  const bookingForm = () => (
    ...
    <br/>
      ...
      <div class="row g-3">
          ...
          <div class="col-md-6">
            <label for="inputZip" class="form-label">Preferred Date</label>
            <input type="date" 
...
<br/>
          <div class="col-12">
            <label for="inputState" class="form-label">Additional Comments/Your Preferences</label>
            <textarea
              type="number"
  ...
  return (
    <Base navigation="" title="Book a Venue" description=" Book your Favourite Venue">
