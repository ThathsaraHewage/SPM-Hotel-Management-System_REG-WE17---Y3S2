          ...
          <div className="container p-4">
            <table border="0" width="100%">
              <tr>
                ...
                <th className="container  p-4" id="themeColor"> Room Type</th>
                <th className="container p-4" id="themeColor"> Description</th>
                <th className="container  p-4" id="themeColor"> Condition</th>
                <th className="container  p-4" id="themeColor"> No.of Rooms</th>
                {/* <th className="container bg-danger p-4"> Price Range</th> */}
                <th className="container  p-4" id="themeColor"> Status</th>
              ...
              {RoomTypes.map((RoomTypes, index) => {
                return (
                  <tr key={index}>
                    <td>{index + 1}</td>
                    <td>
                      <ImageHelper className="mr-3" product={RoomTypes} />
                    </td>
