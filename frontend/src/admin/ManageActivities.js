          ...
          <div className="container p-4">
            <table border="0" width="100%">
              <tr>
                ...
                <th className=" text-white" id="themeColor"> Image</th>
                <th className="container p-4" id="themeColor"> Activity Name</th>
                <th className="container p-4" id="themeColor"> Description</th>
                <th className="container p-4" id="themeColor"> Inclusions</th>
                <th className="container p-4" id="themeColor"> Available Days</th>
                <th className="container p-4" id="themeColor"> Available Time</th>
                <th className="container p-4" id="themeColor"> Price</th>
                <th className="container p-4" id="themeColor"> Update</th>
                <th className="container p-4" id="themeColor"> Delete</th>
              </tr>
              {Activities.map((Activities, index) => {
                return (
                  <tr key={index}>
                    <td>{index + 1}</td>
                    <td>
                      <ImageHelper className="mr-3" product={Activities} />
                    </td>
